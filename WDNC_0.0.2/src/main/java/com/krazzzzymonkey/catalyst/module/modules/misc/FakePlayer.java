...
public class FuckDoll extends Modules {
    ...
    public FuckDoll() {
        super("FuckDoll", ModuleCategory.MISC, "Spawns in a Fuck Doll for testing your config");
    ...
    public void onEnable() {
        ...
        clonedPlayer = new EntityOtherPlayerMP(mc.world, new GameProfile(UUID.fromString("3a54cd18-783e-4b6c-9f5f-70c23fd9dca9"), "Fuck_Doll"));
