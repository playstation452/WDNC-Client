...
public class ClickGui extends Modules {
    ...
    public ClickGui() {
        ...
        clickGuiColor = new ColorValue("HeaderColor", Color.RED, "Changes the header color of the click gui");
        clickGuiBackGroundColor = new ColorValue("BackgroundColor", Color.BLACK, "Changes the background color of the click gui");
        clickGuiToggledColor = new ColorValue("ToggledColor", Color.RED, "Changes the color of all toggled modules in the click gui");
