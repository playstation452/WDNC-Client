                ...
                if (e instanceof EntityPlayer && !e.getName().equalsIgnoreCase(Minecraft.getMinecraft().player.getName())) {
                    if (!knownPlayers.contains(e)) {
                        ...
                        if (clientSide.getValue()) {
                            ChatUtils.message(e.getName() + " This faggot entered our visual range.");
                        } else {
                            Minecraft.getMinecraft().player.sendChatMessage(e.getName() + " This faggot entered our visual range.");
                        }
                    }
                }
            }
