...
public class InvPreview extends Modules {
    ...
    public InvPreview() {
        ...
        this.boarderColorValue = new ColorValue("BorderColor", Color.RED, "Selects color of border around inventory preview");
        this.boarderColorRainbow = new BooleanValue("BorderRainbow", false, "Makes the background cycle through colors");

        this.boarderColorValue = new ColorValue("BorderColorValue", Color.RED, "Border color of inventory preview");
