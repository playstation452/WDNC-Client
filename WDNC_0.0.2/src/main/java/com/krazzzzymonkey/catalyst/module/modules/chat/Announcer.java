...
public class Announcer extends Modules {
    ...
    public static String walkMessage = "I just walked {blocks} blocks!";
    public static String throwMessage = "I just threw {amount} {name} ! ";
    public static String placeMessage = "I just placed {amount} {name} !";
    public static String jumpMessage = "I just jumped!";
    public static String sneakMessage = "I started sneaking!";
    public static String unSneakMessage = "I stopped sneaking!";
    public static String breakMessage = "I just broke {amount} {name} !";
    public static String attackMessage = "I just attacked {name} with a {item} !";
    public static String eatMessage = "I just ate {amount} {name} !";
    public static String openGuiMessage = "I just opened WDNC ClickGUI!";
    public static String closeGuiMessage = "I just closed WDNC ClickGUI!";
    public static String enchantMessage = "I just enchanted an item!";
