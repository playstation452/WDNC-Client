...
public class TargetHUD extends Modules {
    ...
    public TargetHUD() {
        super("TargetHUD", ModuleCategory.HUD, "Shows information about the nearest enemy", true);
        this.players = new BooleanValue("Players", true, "Targets players in target hud");
        this.monsters = new BooleanValue("Monsters", false, "Targets monster creatures in target hud");
        this.animals = new BooleanValue("Animals", false, "Targets animals in target hud");
