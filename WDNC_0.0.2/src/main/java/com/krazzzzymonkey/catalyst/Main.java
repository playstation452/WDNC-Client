...
@Mod(modid = "wdnc", name = "WDNC", version = "0.0.1", clientSideOnly = true, guiFactory = "com.krazzzzymonkey.catalyst.managers.accountManager.config.GuiFactory", acceptableRemoteVersions = "*")
public class Main {
    ...
    public static final String NAME = "WDNC";
